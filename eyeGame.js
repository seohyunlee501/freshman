class eyeGame extends Game {
  ...
  interrupt() {
    ...
    if (!this.gameOver && this.currentNumber < 5) {
      if (this.currentNumber == 1) {
        ...
        if (
          this.playerCalledTime - this.lastCalledTime <
  ...
  npcPlay() {
    ...
    if (!this.endNPC && !this.endPlayer) {
      if (
        !this.gameOver &&
        this.randChar[0][0].die == false &&
        this.randChar[0][2] == false &&
        millis() - this.lastCalledTime > this.randChar[0][1]
      ) {
        ...
        this.randChar[0][0].die == false &&
        this.randChar[0][2] == false &&
        this.randChar[0][1] < this.failureInterval
      ) {
        this.idx = this.randChar[0][3];
        this.npcOneDisplay = true;
    ...
    if (!this.endNPC && !this.endPlayer) {
      if (
        !this.gameOver &&
        this.randChar[1][0].die == false &&
        this.randChar[1][2] == false &&
        millis() - this.lastCalledTime > this.randChar[1][1] &&
        this.randChar[1][1] > this.failureInterval &&
        this.randChar[0][2] == true
      ) {
    ...
    if (!this.endNPC && !this.endPlayer) {
      if (
        !this.gameOver &&
        this.randChar[2][0].die == false &&
        this.randChar[2][2] == false &&
        millis() - this.lastCalledTime > this.randChar[2][1] &&
        this.randChar[2][1] > this.failureInterval &&
        this.randChar[1][2] == true
      ) {
    ...
    if (!this.endNPC && !this.endPlayer) {
      if (
        !this.gameOver &&
        this.randChar[3][0].die == false &&
        this.randChar[3][2] == false &&
        millis() - this.lastCalledTime > this.randChar[3][1] &&
        this.randChar[3][1] > this.failureInterval &&
        this.randChar[2][2] == true
      ) {
    ...
    if (!this.endNPC && !this.endPlayer) {
      if (
        !this.gameOver &&
        this.randChar[4][0].die == false &&
        this.randChar[4][2] == false &&
        millis() - this.lastCalledTime > this.randChar[4][1] &&
        this.randChar[4][1] > this.failureInterval &&
        this.randChar[3][2] == true
      ) {
